...
onMounted(() => {
  ...
  request.get('/data/analysis/sys').then(res => {
      ...
      <el-row :gutter="10">
        <el-col :span="6">
          <el-card style="height: 100px;">
            ...
            <div style="font-size: 24px; font-weight: bold; text-align: center">{{ state.bizNums.user_count }}</div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card style="height: 100px;">
            <div style="color: #888">订单数量</div>
            <div style="font-size: 24px; font-weight: bold; text-align: center">{{ state.bizNums.order_count }}</div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card style="height: 100px;">
            <div style="color: #888">动态数量</div>
            <div style="font-size: 24px; font-weight: bold; text-align: center">{{ state.bizNums.dynamic_count }}</div>
          </el-card>
        </el-col>
        <el-col :span="6">
          <el-card style="height: 100px;">
            <div style="color: #888">动态标签数量</div>
            <div style="font-size: 24px; font-weight: bold; text-align: center">{{ state.bizNums.tag_count }}</div>
          </el-card>
        </el-col>
      </el-row>
    </div>
